...
**Root Cause:** Running LoKO commands before initialization or in wrong directory
...
# Or use init (generates default config)
loko init
...
loko status --config-file /path/to/loko.yaml
```
