...
# Add multiple
loko workloads add mysql postgres mongodb
```
...
loko workloads add valkey cache-ui
loko env create
...
loko env create
# Later: add the UI
loko workloads add mysql-ui --deploy
```
...
loko workloads add postgres valkey
loko env create
...
```bash
# Add infrastructure
loko workloads add postgres rabbitmq valkey
loko env create
...
```bash
# Add both databases
loko workloads add postgres mongodb
loko env create
...
loko workloads add rabbitmq garage
loko env create
