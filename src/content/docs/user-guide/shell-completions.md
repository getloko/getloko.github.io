...
| `workloads enable` | `<workload>` | Enabled workloads | `loko.yaml` | `workloads/_shared.py:30` |
| `workloads disable` | `<workload>` | Enabled workloads | `loko.yaml` | `workloads/_shared.py:30` |
...
| `workloads endpoints` | `[workloads...]` | Enabled workloads | `loko.yaml` | `workloads/_shared.py:32` |
| `workloads connect` | `<workload>` | Enabled workloads | `loko.yaml` | `workloads/_shared.py:30` |
| `workloads check` | `[workloads...]` | Enabled workloads | `loko.yaml` | `workloads/_shared.py:32` |
...
**Use Case**: Multi-environment setups, `env switch <name>`
