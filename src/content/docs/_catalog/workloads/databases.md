...
```bash
loko workloads add mysql --deploy
...
```bash
loko workloads add mongodb --deploy
...
```bash
loko workloads add dynamodb-local --deploy
...
**Deployment:**
```bash
loko workloads add postgres-ui --deploy
```
...
**Deployment:**
```bash
loko workloads add mongodb-ui --deploy
```
...
**Deployment:**
```bash
loko workloads add dynamodb-admin --deploy
```
