...
✓ mkcert is installed (version 1.4.4)
...
2. ✅ Create TLS certificates with mkcert
3. ✅ Start DNS service
...
Credentials are automatically saved to `.loko/<env-name>/workload-secrets.json`
:::
...
You may see a certificate warning on first access. Click "Advanced" and "Proceed" - the certificate is from your local mkcert CA.
:::
